...
#
# Unmodified apart from import paths - this is the class for Turing Smart
# Screen (rev. A) 3.5" and UsbMonitor screens (all sizes), which is what
# the "USB35INCHIPSV2" / CH552T (vid=0x1a86, pid=0x5722) hardware
# identifies as.
